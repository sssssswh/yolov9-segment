...
def run(
    ...
    if save_json and len(jdict):
        ...
        anno_json = str(Path('/vol/ecrg-solar/ziyisun/treespecies/coco/val/labels.json'))  # annotations
...
def print_result(eval, metric):
        ...
        for metric_item in metric_items:
            ...
            val = float(
                f'{eval.stats[coco_metric_names[metric_item]]:.3f}'
            )
